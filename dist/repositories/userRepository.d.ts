...
export declare const setPasswordResetToken: (userId: string, resetToken: string, resetExpiry: Date) => Promise<void>;
export declare const findUserByResetToken: (resetToken: string) => Promise<User | null>;
export declare const clearPasswordResetToken: (userId: string) => Promise<void>;
